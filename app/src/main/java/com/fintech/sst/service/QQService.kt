...
class QQService : Service() {
    private val TAG = "QQService"
...
//                })
                ...
                val notice = Notice()
                notice.content = "QQ到账$order_money"
//                notice.saveTime = notification.`when`
                ...
                notice.packageName = "com.tencent.mobileqq"
                ...
                .subscribe(object : Observer<ResultEntity<Notice>> {
                    ...
                    override fun onNext(resultEntity: ResultEntity<Notice>) {
                        ...
                        if (resultEntity.msg == "success" && notice != null) {
                            notice.status = 1
                            DB.updateAll(this@QQService, notice)
                        }
