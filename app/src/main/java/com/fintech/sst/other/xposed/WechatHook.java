			...
			protected void beforeHookedMethod(MethodHookParam param)
				 ...
				 try {
                    ...
                    if(type==318767153){
                        ...
                        broadCastIntent.putExtra("bill_type", "1001");
...
//					XposedHelpers.callMethod(test.newInstance(), "a", object,true,true);
			...
			XposedHelpers.findAndHookMethod("com.tencent.mm.plugin.collect.b.s", classLoader, "a", int.class, String.class, JSONObject.class, new XC_MethodHook() {
				@Override
				protected void afterHookedMethod(MethodHookParam param) throws Throwable {

						JSONObject object = (JSONObject) param.args[2];
						if (object.optString("retmsg", "").equals("ok")) {
							final String url = object.optString("pay_url");

							final Double money=XposedHelpers.getDoubleField(param.thisObject, "kcp" );
							final String mark =  XposedHelpers.getObjectField(param.thisObject, "desc" )+"";
							XposedBridge.log(" money"+money+" mark "+mark+" payurl"+url);
	...
	public static void  getPayUrl(double money,String remark) {
		Class clzz=  XposedHelpers.findClass("com.tencent.mm.plugin.collect.b.s", classLoader);
		//  Object o =XposedHelpers.newInstance(clzz,money,"1",remark);
		Object o = null;
		try {
			o = clzz.getConstructor(double.class,String.class,String.class).newInstance( money,"1",remark);
		...
		XposedBridge.log(" clzz "+o+" money "+money+" remark "+remark);
		//  list.add(o);
		final Class<?> ahClass = XposedHelpers.findClass ("com.tencent.mm.model.av",  classLoader);
		Object obj = XposedHelpers.callStaticMethod(ahClass, "Pw");
		XposedHelpers.callMethod(obj, "a",new Object[]{o, 0});
		XposedBridge.log(" 发送请求 "+obj);
	}
}
