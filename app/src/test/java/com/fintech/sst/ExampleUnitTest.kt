...
//        var pattern = "[^\\d]+(?:[\\d]+[^\\d]+)?[币入额\\)￥](\\d+(,\\d+)*(\\.\\d{0,2})?)(?:元,|元，|,|，)"
...
//        var pattern = "(?:.*)[币入额\\)￥](\\d+(,\\d+)*(\\.\\d{0,2})?)(?:元,|元，|,)"
        ...
        if (m.find()) {
            ...
            when (bankType) {
                ...
                -> {
                    ...
                    println(calendar.timeInMillis.toString())
                    println(m.group(5).replace(",".toRegex(), ""))
                }
                "1"//dd hh:mm
                -> {
                    //                        month = 0;
                    ...
                    println(calendar.timeInMillis.toString())
                    println(m.group(4).replace(",".toRegex(), ""))
                }
                "2"//hh:mm
                -> {
                    //                        month = 0;
                    ...
                    println(calendar.timeInMillis.toString())
                    println(m.group(3).replace(",".toRegex(), ""))
                }
                "3" //mm-dd
                ->
                    //                        month = 0;
                    ...
                    println(m.group(1).replace(",".toRegex(), ""))
                else -> println("0")
            }
        }
    }
    ...
    @Test
    fun parse() {
        println("599.4".toFloat() == "599.4000".toFloat())
//        for (i in 0..9) {
